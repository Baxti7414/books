...
class AuthorsController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            $time = date('YmdHis');
            if($image){
                $model->image = 'images/authors/' . $time . '.' . $image->extension;
            }
            
            if($model->save()){
                if($image){
                    $dir = \Yii::getAlias('@app');
                    $image->saveAs($dir.'/web/images/authors/' .$time . '.' . $image->extension);
                }
            }else{
                vd($model->errors);
            }
